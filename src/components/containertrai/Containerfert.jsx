...
export default function Containerfert({ name, description }) {
    return (
        <>
                    ...
                    <div className="main-left-content-inf">
                        ...
                        <div>
                            <div className="main-left-content-inf-painted">
                                <p className="painted">{description}</p>
                            </div>
                            ...
                            <div className="main-left-content-inf-character">
                                <p>
                                    "Diên nhĩ, Tiểu Thiên Nhất, bên này."
                                    <br />
                                    <br />
                                    An Tuyết Thiên như là hòa tan đông tuyết, kêu vô cùng thân mật,
                                    còn ngoắc.
                                    <br />
                                    <br />
